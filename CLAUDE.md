...
### 🚩 POINT DE REPRISE — D1 et D2 livrés le 2026-08-04 (`v0.5.1`)

> **▶️ POUR DÉMARRER LA PROCHAINE SESSION, IL SUFFIT DE DIRE : « on code le lot D3 ».**
> Rien à redemander : D3 (photo de fin + rapport PDF multi-zones) est spécifié plus bas,
> décision **D9** — global en nominal, détail par zone si interrompu.
>
> ⏰ **PRIORITÉ ABSOLUE AVANT LE 05/08 : essayer D2 sur la machine.** Le critère de fin de
> D2 est « la machine parcourt un plateau réel **en l'air**, du bouton d'accueil au retour
> à l'accueil » — il n'a **pas** été validé, la session s'étant faite à la maison. Tout le
> reste est secondaire tant que ce n'est pas fait. Laisser la case **« dépose à blanc »
> cochée** (elle l'est par défaut).
>
> **Les trois mesures à faire au même moment, machine sous tension** :
...
> - `M4` — sens des axes. Elle se lève **à l'œil** pendant D2 : la buse passe visiblement
>   au coin bas-gauche de chaque zone avant de la tracer. Si elle vise juste, `M4` est
>   levée ; sinon, le signe est faux.
...
> si l'on est à l'atelier, sinon D3.
