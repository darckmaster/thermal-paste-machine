...
- [ ] **Étape 2 zone de dépose — fichier de préparation JSON** : pas commencée. Décidé le 2026-07-30 : stocker les points en **mm relatifs à la zone de dépose**. Reste à trancher : un seul cordon (comme aujourd'hui) ou cordons multiples dès le départ
